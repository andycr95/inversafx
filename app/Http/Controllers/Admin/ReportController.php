...
class ReportController extends Controller
{
    ...
    public function runingTrade(){
        $data['pageTitle'] = 'Running Trade';
        $data['navRuningTrade'] = 'active';
        $data['trades'] = Transaction::where('gateway_transaction', 'main_to_trade')->where('type', '-')->whereDate('created_at', Carbon::today())->paginate(30);
        return view('backend.runing_trade', with($data));
    }
}
