                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="currency_sym"><?php echo e(__(' Currency Symbol')); ?></label>
                                        <input type="text" name="currency_sym" class="form-control"
                                            placeholder="Enter Currency Symbol" value="<?php echo e(@$general->currency_sym ?? ''); ?>">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <label for="refer_need">Refer Need (For Withdraw)</label>
                                        <div class="input-group">
                                            <input type="number" name="refer_need" placeholder="<?php echo app('translator')->get('Minimum Trading Amount'); ?>" class="form-control form_control" value="<?php echo e(@$general->refer_need); ?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text gr-bg-1 text-white"><i class="fa-solid fa-user mr-2"></i> Person</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 mt-2">
                                        <button type="submit" class="btn btn-primary w-100"><?php echo e(__('Update General Setting')); ?></button>
                                    </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u207221236/domains/codeshack.net/public_html/tradedemo/core/resources/views/backend/setting/general_setting.blade.php ENDPATH**/ ?>