                                ...
                                <?php $__currentLoopData = $section['content']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php elseif($sec == 'file'): ?>
                                        <div class="form-group col-md-5 mb-3">
                                            ...
                                            <div id="image-preview" class="image-preview" style="background-image:url(<?php echo e(getFile(request()->name, @$content->data->$key)); ?>);">
                                                <label for="image-upload" id="image-label"><?php echo e(__('Choose File')); ?></label>
                                                <input type="<?php echo e($sec); ?>" name="<?php echo e($key); ?>" id="image-upload" />
                                            </div>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <?php $__currentLoopData = $section['element']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(request()->name != 'brand'): ?>
                                                        <?php if($sec == 'textarea' || $sec == 'textarea_nic' || $key == 'size' || $sec == 'on' || $key == 'unique'): ?>
                                                            <?php continue; ?>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        <?php if($key == 'size'): ?>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr class="text-center">
                                                    ...
                                                    <?php $__currentLoopData = $section['element']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($sec == 'file'): ?>
                                                            <td>
                                                                <img style="height: 60px" src="<?php echo e(getFile(request()->name, @$element->data->$key)); ?>" alt="" class="image-rounded p-2 img-thumbnail rounded-pill">
                                                            </td>
                                                        <?php elseif($sec == 'text'): ?>
                                                            <td><?php echo e(@$element->data->$key); ?></td>
                                                        <?php elseif($sec == 'textarea' || $sec == 'textarea_nic' || $key == 'size' || $sec == 'on' || $key == 'unique'): ?>
                                                            <?php continue; ?>
                                                        <?php else: ?>
                                                            <td><?php echo e(@$element->data->$key); ?></td>
                                                        <?php endif; ?>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u207221236/domains/codeshack.net/public_html/tradedemo/core/resources/views/backend/frontend/index.blade.php ENDPATH**/ ?>