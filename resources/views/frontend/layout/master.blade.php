...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('asset/theme1/frontend/css/cookie.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('asset/theme1/frontend/css/slick.css') }}">
...
<body class="text-capitalize">
    ...
    <script src="{{ asset('asset/theme1/frontend/js/slick.min.js') }}"></script>
    ...
    <script src="{{ asset('asset/theme1/frontend/js/main.js') }}"></script>
