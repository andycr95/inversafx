...
<head>
    ...
    <style>
        ...
        body {
            /* background-image: url('{{asset('asset/images/bg/bg-1.png')}}'); */
            background: #262930;
...
<body class="text-capitalize">
    ...
    <main id="main" class="main-img">
        ...
        <div class="text-center position-absolute w-100">
            <a href="{{route('home')}}">
                <img style="height: 40px" class="pt-2 " src="{{ getFile('logo', @$general->whitelogo) }}" alt="">
            </a>
        </div>
        ...
        $(document).on('click', '#loginPageBtn', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    customPush("{{route('user.login')}}") // url-change
                    btnClr()
                }
            });
        });
        ...
        $(document).on('click', '#registerPageBtn', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $('#appCapsule').html(res);
                    $('#preLoadCustom').addClass('d-none'); // loader-off
                    customPush("{{route('user.register')}}") // url-change
                    btnClr()
                }
            });
        });
