...
<div class="appBottomMenu">
    ...
    <a href="{{route('user.withdraw')}}" class="item customLink">
        <div class="col">
            <img class="white {{ Route::is('user.withdraw') ? 'active' : '' }}" height="30px" width="30px" src="https://cdn-icons-png.flaticon.com/128/5928/5928961.png" alt="">
    ...
    <a href="{{route('user.dashboard')}}" class="item customLink">
        <div class="col">
            <img class="white {{ Route::is('user.dashboard') ? 'active' : '' }}" height="30px" width="30px" src="https://cdn-icons-png.flaticon.com/128/12274/12274974.png" alt="">
            <strong>Mine</strong>
        </div>
    </a>
    @endauth
