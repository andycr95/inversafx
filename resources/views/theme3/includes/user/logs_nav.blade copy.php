<div class="container">
    <div class="card mt-2">
        <div class="card-body text-center">
            <h3 class="pb-2 mb-1 border-bottom">All Logs</h3>
            <div class="row justify-content-center">
                ...
                {{-- <div class="col-4 px-1 mb-1">
                    <a class="btn btn-primary btn-sm w-100 logNav" id="logNavTransfer" href="#">Transfer</a>
                </div> --}}
                <div class="col-4 px-1 mb-1">
                    <a class="btn btn-primary btn-sm w-100 logNav transactionLogBtn" id="logNavTransaction" href="#">Transaction</a>
                </div>
                <div class="col-4 px-1 mb-1">
                    <a class="btn btn-primary btn-sm w-100 logNav commisionLogBtn" id="logNavReferral" href="#">Referral</a>
                </div>
            </div>
        </div>
    </div>
