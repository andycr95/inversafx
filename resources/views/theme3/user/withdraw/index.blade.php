                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        let html = `
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-text">
                                            <span class="withdraw_charge_type">${response.charge_type == 'fixed' ? '{{ $general->site_currency }}' : '%'}<span>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="">{{ __('Withdraw Pin') }} <span class="text-danger">*</span></label>
