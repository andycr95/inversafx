                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <label for="">{{__('Gateway Number/Address')}}</label>
                                        <input type="text" name="gateway_number"  class="form-control" value="{{$gateway->gateway_number}}">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label>{{__('Minimum Limit')}}</label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="min_limit" value="{{@$gateway->min_limit}}">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="max_limit" value="{{@$gateway->max_limit}}">
