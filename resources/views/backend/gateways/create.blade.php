                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="name"  class="form-control" placeholder="Ex: bKash">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="gateway_currency" class="form-control site-currency" placeholder="Ex: $"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="gateway_number"  class="form-control" placeholder="Ex: 017****** / Xrf6f******">
